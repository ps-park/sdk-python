...
class PSPark(AbstractPSPark):
    ...
    def get_balance(self, balance_request: BalanceRequest) -> HttpResponse:
        return self._client.send_request(
    ...
    def create_address(self, address_request: AddressRequest) -> HttpResponse:
        return self._client.send_request(
    ...
    def create_withdrawal(self, withdrawal_request: WithdrawalRequest) -> HttpResponse:
        return self._client.send_request(
    ...
    def get_rates(self, rates_request: RateRequest) -> HttpResponse:
        return self._client.send_request(
            path=ApiURL.RATES,
