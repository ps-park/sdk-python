...
from pspark.requests import Details, WithdrawalRequest
...
class TestWithdrawalRequest(unittest.TestCase):
    ...
    def test_callback_url_validation(self):
        with self.assertRaises(
            ValueError, msg="WithdrawalRequest callback_url validation failed."
        ):
            WithdrawalRequest(
                wallet_id="79CDA5A3-C688-4996-8D20-3EDDF4E6B70B",
                reference="uuid",
